                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/contents"
                                    class="<?= urlIs('/contents') ? 'bg-gray-900 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' ?> rounded-md px-3 py-2 text-sm font-medium">Contents</a>
                                <a href="/notes"
        ...
        <main>
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                if (!empty($_SERVER['PATH_INFO'])) {
                    if ($_SERVER['PATH_INFO'] === '/notes') {
                        require __DIR__ . '/../notes.blade.php';
                    } else if($_SERVER['PATH_INFO'] === '/note') {
                        require __DIR__ . '/../note.blade.php';
                    } else if($_SERVER['PATH_INFO'] === '/notes/create') {
                        require __DIR__ . '/../note-create.blade.php';
                    }
                }
                ?>
            </div>
